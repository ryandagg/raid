...
function createQuillBoarBox() {
    ...
    var middle = new MapLocation(Math.round(width/2), Math.round(height/2));
    map.createTile(middle.add(Direction.NORTH_WEST, 2), middle.add(Direction.SOUTH_WEST, 2), TerrainType.WALL);
    map.createTile(middle.add(Direction.NORTH_WEST, 2), middle.add(Direction.NORTH_EAST, 2), TerrainType.WALL);
    map.createTile(middle.add(Direction.SOUTH_EAST, 2), middle.add(Direction.NORTH_EAST, 2), TerrainType.WALL);
    map.createTile(middle.add(Direction.SOUTH_EAST, 2), middle.add(Direction.SOUTH_WEST, 2), TerrainType.WALL);
