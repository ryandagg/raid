...
AdventureMapFactory.createAdventureMap = function(level) {
    ...
    mapOptions[MapOptions.NUM_SECONDARY_ENEMIES] = 10;
    mapOptions[MapOptions.RARE_ENEMY] = UnitType.GIANT_FROG;
    mapOptions[MapOptions.NUM_RARE_ENEMIES] = 10;
    mapOptions[MapOptions.SWARM_ENEMY] = UnitType.GNAT;
    mapOptions[MapOptions.NUM_SWARM_ENEMIES] = 20;
    mapOptions[MapOptions.BOSS_ENEMY] = UnitType.GNAT;
    mapOptions[MapOptions.NUM_BOSS_ENEMIES] = 1;
    mapOptions[MapOptions.TERRAIN_FILL] = 1;
    mapOptions[MapOptions.TERRAIN_DENSITY] = .1;
    ...
    difficulty = Math.round(level / 10);
    level = level % 10;
    switch(level) {
        case 1:
            mapOptions = {};
            ...
            mapOptions[MapOptions.TERRAIN_FILL] = 1;
            mapOptions[MapOptions.TERRAIN_DENSITY] = 1;
            return createLegalMap(ForestCreator.create, 31, 51, mapOptions);
        case 2:
            mapOptions = {};
            mapOptions[MapOptions.PRIMARY_ENEMY] = UnitType.GIANT_FROG;
            mapOptions[MapOptions.SWARM_ENEMY] = UnitType.GNAT;
