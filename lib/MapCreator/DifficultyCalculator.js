...
function getEnemiesForLevel(level, difficulty) {
    if (difficulty < 3) {
        ...
        switch(level) {
            //[primary, secondary, swarm, rare, boss]
            // Forest Level
            case 1: return [UnitType.GIANT_TICK, UnitType.QUILL_BOAR, UnitType.GNAT, UnitType.AMBROSE, UnitType.WUMPUS];
            // Camp Level
            case 2: return [UnitType.ORC, UnitType.ORC, UnitType.JACKEL, UnitType.CHRIS, UnitType.GIANT];
            // Mountain Pass Level
            case 3: return [UnitType.ROCKS, UnitType.FLY, UnitType.GIANT_LOUSE, UnitType.BULL, UnitType.YETI];
            // Cave Level
            case 4: return [UnitType.ICKY_THING, UnitType.KOBOLD, UnitType.KILLER_BEETLE, UnitType.UMBER_HULK, UnitType.NECROMANCER];
            // Swamp Level
            case 5: return [UnitType.GIANT_TICK, UnitType.GIANT_FROG, UnitType.KILLER_BEETLE, UnitType.TROLL, UnitType.WUMPUS];
            // Dessert level
        ...
        switch(level) {
            //[primary, secondary, swarm, rare, boss]
            // Forest Level
            case 1: return [UnitType.JACKEL, UnitType.GELATINOUS_CUBE, UnitType.BULL, UnitType.ZOMBIE, UnitType.RAPHAEL];
            // Camp Level
            case 2: return [UnitType.KOBOLD, UnitType.SCORPION, UnitType.BOVARD, UnitType.NECROMANCER, UnitType.GIANT];
            // Mountain Pass Level
            case 3: return [UnitType.GHOST, UnitType.HOBGOBLIN, UnitType.KILLER_BEETLE, UnitType.WUMPUS, UnitType.ANCIENT_DRAGON];
            // Cave Level
            case 4: return [UnitType.OOZE, UnitType.MUSHROOM, UnitType.VAMPIRE, UnitType.ROCKS, UnitType.QUYLTHULG];
            // Ocean Level
            case 5: return [UnitType.GIANT_ANT_LION, UnitType.MOLD, UnitType.WORM, UnitType.NECROMANCER, UnitType.ELEMENTAL];
            // Dessert level
            case 6: return [UnitType.GIANT_TICK, UnitType.SKELETON, UnitType.REPTILE, UnitType.HOBGOBLIN, UnitType.AMBROSE];
            // Dessert Camp level
            case 7: return [UnitType.DRUNK_VIKING, UnitType.ORC, UnitType.GIANT_LOUSE, UnitType.SCORPION, UnitType.GIANT];
            // Deep Woods level
            case 8: return [UnitType.KOBOLD, UnitType.SKELETON, UnitType.BULL, UnitType.DRAGON, UnitType.LICH];
            // Sewer level
            case 9: return [UnitType.REPTILE, UnitType.UMBER_HULK, UnitType.KILLER_BEETLE, UnitType.AMBROSE, UnitType.TROLL];
            // Maze level
                // (maze doesn't have primary, secondary or swam)
