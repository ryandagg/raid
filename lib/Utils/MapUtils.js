...
function connectLocationsStraightLine(map, start, finish, width, terrainType) {
    var i, left, right, d;
    var loc = start;
    var idx = 0;
...
function connectLocationsElbow(map, start, finish, width, terrainType) {
...
function connectLocationsDrunkWalk(map, start, finish, width, terrainType, drunkness) {
    var i, left, right, d;
    var loc = start;
    var idx = 0;
