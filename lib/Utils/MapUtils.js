...
function drawBox(map, loc1, loc2, terrainType) {
    var upLeft = new MapLocation(Math.min(loc1.x, loc2.x), Math.min(loc1.y, loc2.y));
    var upRight = new MapLocation(Math.min(loc1.x, loc2.x), Math.max(loc1.y, loc2.y));
    ...
    map.createTiles(upLeft, upRight, terrainType);
    map.createTiles(upRight, botRight, terrainType);
    map.createTiles(botRight, botLeft, terrainType);
    map.createTiles(botLeft, upLeft, terrainType);
