...
PlayerRenderer.prototype.render = function(playerState, mapState){
	var canvasPos = _getCanvasPosFromMapPos.call(this, playerState.location, mapState.width, mapState.height);
	this.fx.drawText({
